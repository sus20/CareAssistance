class ExerciseData {
  static List<Map<String, String>> sportsData = [
    {
      // Text-Quelle: https://www.qigong-akademie.at/3-qigong-uebungen-fuer-dein-wohlfuehlgewicht-das-erd-element/
      'Video': 'https://www.youtube.com/watch?v=LXktIYFOz0k&t=25s',
      'Titel': 'Qigong',
      'Text': '''Öffne die Arme im Stehen zur Seite.
...
Atem: Den Atem frei fließen lassen.''',
      'Beschreibung':
          "Quigong ist besonders hilfreich, falls du Muskelentspannungen lösen willst."
    },
...
(12) Ausatmen: Arme senken. Übe nun die gleiche Übungsabfolge auf der linken Seite. Wenn du beide Seiten geübt hast, hast du eine vollständige Runde Sonnengruß gemacht. Um dich gut aufzuwärmen, praktiziere 6-12 Runden.''',
      'Beschreibung':
          "Diese Yogatechnik wird dir helfen, mit voller Energie in den Tag zu starten."
    },
    ...
    // Text-Quelle: https://www.pilates.de/pilates-uebungen-training/training-a-fuer-anfaenger-pilates-uebungen/schulterschoen-pilates-uebung
    {
      ...
      'Beschreibung':
          "Die perfekte Übung, um in kurzer Zeit deinen Körper zu entspannen."
    },
    ...
    // Text-Quelle: https://www.yoga-vidya.de/yoga-uebungen/asana/sphinx-36846/
    {
      ...
      'Beschreibung':
          "Diese Yogatechnik führt durch gezielte Bewegungen zur Enstpannung der Rückenmuskulatur."
    },
...
So kenne ich drei verschiedene Arten, beim Stehen das Gewicht auf seine Füße zu lagern. Die meisten verteilen das Gewicht gleichmäßig auf den Fuß. Dabei kann Qi genauso gut aufsteigen wie es absteigen kann.''',
      'Beschreibung':
          "Durch gezielte Gewichtsverlagerung wird dir hier ein Horizont an Entspannungsübungen eröffnet."
    }
  ];
...
Wenn du fertig bist mit meditieren, bleib noch für eine Minute mit geschlossenen Augen sitzen und spür nach. Wie fühlt sich dein Körper an? Wie ruhig bist du? Was für Gedanken kommen dir nach der Meditation wieder in den Kopf?''',
      'Beschreibung':
          "Diese Technik hilft dir, durch gezieltes Atmen und Flüstern nach einem langen Tag zur Ruhe zu kommen."
    },
    ...
    // Text-Quelle: https://www.vital.de/wohlbefinden/entspannung/die-zehn-besten-meditationsuebungen-2186.html
    {
      ...
      'Beschreibung':
          "Durch Vorstellungskraft kannst du hier auf andere Gedanken kommen und aus dem Alltag fliehen."
    },
    ...
    // Text-Quelle: https://www.vital.de/wohlbefinden/entspannung/die-zehn-besten-meditationsuebungen-2186.html
    {
      ...
      'Beschreibung':
          "Durch geführte Meditation wirst du mit der Kraft des Feuers selbst neue Kräfte schöpfen."
    },
    ...
    // Text-Quelle: https://www.vital.de/wohlbefinden/entspannung/die-zehn-besten-meditationsuebungen-2186.html
    {
      ...
      'Beschreibung':
          "Diese Übung wird dir helfen, durch Gedanken an das Licht deine Gedanken auf die wichtigen Dinge zu lenken. "
    },
    ...
    // Text-Quelle: https://www.vital.de/wohlbefinden/entspannung/die-zehn-besten-meditationsuebungen-2186.html
    {
      ...
      'Beschreibung':
          "Falls du dich müde und ausgelaugt fühlst, wirst du hier neue Kräfte schöpfen können."
    },
  ];
}
